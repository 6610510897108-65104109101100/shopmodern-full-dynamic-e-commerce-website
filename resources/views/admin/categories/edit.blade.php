...
@section('title', 'Refine Collection — ShopModern')
...
<div class="mb-10">
    ...
    <p class="text-slate-500 dark:text-slate-400 font-medium text-sm italic ml-14">Updating: {{ $category->name }}</p>
</div>
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <div class="relative group aspect-[4/5] rounded-[2.5rem] bg-slate-50 dark:bg-slate-800 border-2 border-dashed border-slate-200 dark:border-slate-700 overflow-hidden flex flex-col items-center justify-center transition-all hover:border-primary cursor-pointer">
                    ...
                    <div id="image-placeholder" class="text-center group-hover:-translate-y-2 transition-transform {{ $category->image ? 'opacity-0' : '' }}">
                    ...
                    <img id="image-preview" src="{{ $category->image_url }}" class="absolute inset-0 w-full h-full object-cover pointer-events-none">
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <div class="relative group font-display">
                    ...
                    <input name="name" value="{{ old('name', $category->name) }}" placeholder="e.g. Minimalist Essentials" class="w-full pl-12 pr-4 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-amber-400 transition-all font-black text-xl tracking-tight" required>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="description" rows="6" placeholder="Describe the mood, aesthetic, and purpose of this collection..." class="w-full px-5 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-amber-400 transition-all font-medium text-slate-700 dark:text-slate-300 italic min-h-[160px]">{{ old('description', $category->description) }}</textarea>
            </div>
