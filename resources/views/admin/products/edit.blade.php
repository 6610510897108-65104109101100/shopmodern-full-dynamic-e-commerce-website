...
<div class="mb-10">
    ...
    <p class="text-slate-500 dark:text-slate-400 font-medium text-sm italic ml-14">Updating: {{ $product->name }}</p>
</div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
        ...
        <div class="md:col-span-2">
            ...
            <div class="relative group">
                ...
                <input name="name" value="{{ old('name', $product->name) }}" placeholder="e.g. Premium Cotton T-Shirt" class="w-full pl-12 pr-4 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-primary dark:focus:ring-primary transition-all font-bold" required>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input name="sku" value="{{ old('sku', $product->sku) }}" placeholder="SKU-12345" class="w-full pl-12 pr-4 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-primary dark:focus:ring-primary transition-all font-bold uppercase tracking-wider" required>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="flex flex-wrap gap-2">
                @php $productSizes = (array) $product->sizes; @endphp
                @foreach(['S', 'M', 'L', 'XL', '2XL', '3XL'] as $size)
                    <div class="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-black text-xs text-slate-500 hover:border-primary transition-colors cursor-pointer">
                        <input type="checkbox" name="sizes[]" value="{{ $size }}" @checked(in_array($size, old('sizes', $productSizes))) class="rounded text-primary focus:ring-primary border-slate-300">
                        {{ $size }}
                    </div>
                @endforeach
            </div>
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input name="colors_raw" value="{{ old('colors_raw', implode(', ', (array) $product->colors)) }}" placeholder="Red, Blue, Green..." class="w-full pl-12 pr-4 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-primary transition-all font-bold">
            </div>
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input name="fabric_type" value="{{ old('fabric_type', $product->fabric_type) }}" placeholder="e.g. Double PK" class="w-full pl-12 pr-4 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-indigo-500 transition-all font-bold">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input name="yarn_count" value="{{ old('yarn_count', $product->yarn_count) }}" placeholder="e.g. 26/1" class="w-full pl-12 pr-4 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-indigo-500 transition-all font-bold">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input name="composition" value="{{ old('composition', $product->composition) }}" placeholder="e.g. 80% Cotton + 20% Polyester" class="w-full pl-12 pr-4 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-indigo-500 transition-all font-bold">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input name="gsm" value="{{ old('gsm', $product->gsm) }}" placeholder="e.g. 210-220" class="w-full pl-12 pr-4 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-indigo-500 transition-all font-bold">
            </div>
        </div>
        ...
        <div class="md:col-span-2">
            ...
            <div class="relative group">
                ...
                <input name="color_type" value="{{ old('color_type', $product->color_type) }}" placeholder="e.g. Reactive Dye, Enzyme Washed" class="w-full pl-12 pr-4 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-indigo-500 transition-all font-bold">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input name="price" type="number" step="0.01" value="{{ old('price', $product->price) }}" placeholder="1090" class="w-full pl-12 pr-4 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-primary transition-all font-black text-primary text-lg" required>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="relative group">
                ...
                <input name="stock" type="number" value="{{ old('stock', $product->stock) }}" placeholder="100" class="w-full pl-12 pr-4 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-primary transition-all font-bold" required>
            </div>
        </div>

        <div class="flex items-center gap-4 mt-6 ml-1">
            <div class="relative inline-block w-12 h-6 transition duration-200 ease-in-out">
                <input type="checkbox" name="is_active" id="is_active" value="1" @checked(old('is_active', $product->is_active)) class="absolute w-6 h-6 rounded-full bg-white border-4 appearance-none cursor-pointer peer checked:bg-primary checked:right-0 right-6 transition-all duration-300">
                    ...
                    <div class="flex flex-wrap gap-4">
                        @foreach($product->images as $img)
                            <div class="relative group/img h-28 w-28 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-all">
                                ...
                                <div onclick="deleteImage('{{ route('admin.products.images.destroy', $img->id) }}')" class="absolute inset-0 bg-black/40 opacity-0 group-hover/img:opacity-100 flex items-center justify-center transition-opacity cursor-pointer">
        ...
        <div class="md:col-span-2">
            ...
            <textarea name="description" rows="4" placeholder="Tell your customers more about this item..." class="w-full px-5 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border-none ring-1 ring-slate-200 dark:ring-slate-700 focus:ring-2 focus:ring-primary transition-all font-medium text-slate-700 dark:text-slate-300 min-h-[120px]">{{ old('description', $product->description) }}</textarea>
        </div>
