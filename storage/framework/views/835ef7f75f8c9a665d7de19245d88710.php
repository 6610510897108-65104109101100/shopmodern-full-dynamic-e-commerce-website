            ...
            <div class="flex flex-wrap gap-2">
                <?php $__currentLoopData = ['S', 'M', 'L', 'XL', '2XL', '3XL']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 font-black text-xs text-slate-500 hover:border-primary transition-colors cursor-pointer">
                        <input type="checkbox" name="sizes[]" value="<?php echo e($size); ?>" class="rounded text-primary focus:ring-primary border-slate-300">
                        <?php echo e($size); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp3\htdocs\ShopModern\shopmodern\shopmodern\resources\views/admin/products/create.blade.php ENDPATH**/ ?>