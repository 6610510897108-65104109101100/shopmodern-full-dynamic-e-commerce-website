...
<?php $__env->startSection('title', 'New Arrivals - ShopModern'); ?>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden border border-slate-100 dark:border-slate-800">
            ...
            <div class="p-5">
                <div class="text-xs text-[#4c739a] dark:text-slate-400 font-bold uppercase mb-2"><?php echo e($p->category->name); ?></div>
                <div class="font-bold mb-2 line-clamp-1"><?php echo e($p->name); ?></div>
                <div class="text-xl font-black mb-4">$<?php echo e($p->price); ?></div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp3\htdocs\ShopModern\shopmodern\shopmodern\resources\views/public/new-arrivals.blade.php ENDPATH**/ ?>